...
- **CORRECTED 2026-09-23.** As first written, this item said no Lorentzian vacuum example existed *at all*
  ...
  V⁽⁴⁾ — **is harmonic** and does carry a cubic integral. My literature sweep missed it because it was never
  in the literature: it was in our own workspace (rule 110, one level up — search the fleet's folders too).
