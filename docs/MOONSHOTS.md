...
- **CORRECTED 2026-09-23.** As first written, this item said no Lorentzian vacuum example existed *at all*
  ...
  2017 (Russian, off arXiv; INSPIRE 1620354) built it with its two quadratic Killing tensors and named a cubic
  integral as the open problem. The rank-3 tensor itself — one Poisson bracket away — appears not to be in
  print; our workspace found it. My sweep missed both the paper (language, venue) and our workspace.
