...
**Open.** Nothing. The KK reading of the 5D metric was verified in EXP-004 (2026-09-23): exact
4D Einstein–Maxwell pp-wave with a null Maxwell field, identities checked off-shell. The 5D
squeeze closed at 3/9/20. Rank ≥ 5 remains parked by the user.

## Fleet coordination (2026-09-23)

`plans/FLEET_PLAN.md` synthesises the six sister plan files. Items proposed for this repo, **none
started, pending the user**: H-1 (supply the rank-3 vacuum metric sealed for tabula's blind screen),
H-2 (functionally independent rank ≥ 3 in Lorentzian vacuum, or a class-restricted no-go),
H-3 (is SW-IV σ=0 the only harmonic planar second-order superintegrable potential?), H-4 (ship
EXP-002 in the shared certificate format). Stale claims about this repo's result in other plans:
bridge B-1/G-3 and ansatz A-1 (reconciliation rows R-1, R-2).
